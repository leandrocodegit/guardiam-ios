...
- (instancetype)init {
    ...
    self.sharedUserDefaults = [[NSUserDefaults alloc] initWithSuiteName:@"group.br.guardiam.com"];
...
- (void)setMonitoring:(LocationMonitoring)monitoring {
    ...
    NSUserDefaults *shared = [[NSUserDefaults alloc] initWithSuiteName:@"group.br.guardiam.com"];
